package com.example.onlineshoppingservice.advice;
...
public class ApplicationExceptionHandler {
    ...
    @ExceptionHandler({ProductNotFoundException.class, ReviewNotAllowedException.class, ReviewNotFoundException.class})
